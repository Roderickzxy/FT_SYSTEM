...
<body>
	<form action="savepic.html" name="picForm" id="picForm" target="result" method="post">
	<input type="hidden" name="id" id="id" value="${pic.id}"/>
	<input type="hidden" name="houseResourceid" id="houseResourceid" value="${houseResource.id}"/>

...
<body>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="main_table">
		...
		<c:choose>
			<c:when test="${not empty customerpropertyList}">
				...
				<td>${customerproperty.name}</td>
					<td> <a href="javascript:editcustomerproperty(${customerproperty.id });">设置</a> <%-- | <a href="javascript:delcustomerproperty(${customerproperty.id });">删除</a> --%></td>
				</tr>
				</c:forEach>
			</c:when>
			<c:otherwise>
	...
	<script type="text/javascript">
		...
		function editcustomerproperty(customerpropertyid){
			var dg = new $.dialog({
				title:'修改',
				id:'customerproperty_edit',
				width:360,
				height:360,
				iconTitle:false,
				cover:true,
				maxBtn:false,
				resize:false,
				page:'customerproperty/edit.html?id='+customerpropertyid
				});
    		dg.ShowDialog();
		}

 ...
 */ 
@Controller
@RequestMapping(value="/customerproperty")
public class CustomerpropertyController {
	
	private final static Logger log= Logger.getLogger(CustomerpropertyController.class);
...
//		User usernew = userService.getUserById(user.getUserId());
	...
	public ModelAndView toEdit(@RequestParam Integer id){
		...
		mv.addObject("customerproperty", customerproperty);
		mv.setViewName("customerproperty_info");
		return mv;
	}
	/**
	 * 删除
